...
public class MapperConfig {
    ...
    public ModelMapper medicMapper(){
        ...
        typeMap1.addMapping(MedicDTO::getPrimaryName, (dest,v) -> dest.setFisrtName((String) v));
        ...
        typeMap2.addMapping(Medic::getFisrtName, (dest,v) -> dest.setPrimaryName((String) v));
